...
class _SignInPage extends State<SignInPage> {
  ...
  Future loginUser() async {
    ...
    var apiurl = 'https://myfutsal123.000webhostapp.com/loginmf.php';
    ...
    if (message == 'Success') {
      ...
      Navigator.push(
          context,
          MaterialPageRoute(
              builder: (context) => LoginSuccess(email: emailController.text)));
    } else {
      setState(() {
        showprogress = false;
      });
            ...
            child:Column(children:<Widget>[
              ...
              Container(
                ...
                child: InkResponse(
                    ...
                    child:Text("If you Have Stadium? SignIn As Owner",
                      style: TextStyle(color:Colors.white, fontSize:18),
                    )
                ),
              ),
